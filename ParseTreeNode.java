...
public class ParseTreeNode {
	 ...
	 * given children. Throws a RuntimeException if you enter more than
	 ...
	 * @throws RunTimeException if you pass in >2 children
	 */
	public ParseTreeNode(Symbol symbol, ParseTreeNode... children) {
		if(children.length > 2) {
			throw new RuntimeException("ParseTreeNode should never have more than 2 children if grammar is in CNF.");
		}
	 ...
	 */
	public void print() {
		TreePrinter<ParseTreeNode> printer = new TreePrinter<>(n -> ""+n.getSymbol(), n -> n.getLeft(), n -> n.getRight());
        printer.setHspace(2);
        // use square branches
	...
	public static ParseTreeNode emptyParseTree(Variable variable) {
		return new ParseTreeNode(variable, new ParseTreeNode(new Terminal('ε')));
	}
